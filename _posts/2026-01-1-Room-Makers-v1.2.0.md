...
+ Added a new gamemode: Classic!
    ...
    + Kits do not appear on classic mode.
    + Labels are not important for scoring.
    + Made kits & tags functionality mode dependant.
...
+ Fixed a bug where objects on the floor wouldn't give points when unboxed. (Twice)
+ Threw a LOT of stuff at the wall to see what sticked.